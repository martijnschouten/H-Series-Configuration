...
M308 S3 P"duex.e4temp" Y"pt1000"; Create Sensor 3 assigned to duex.e4temp pin, thermistor type with resistance of 100Kohms at 25C, reciprocal of Steinhart-Hart B coefficient 3950, Steinhart-Hart C coefficient 0, and call it "Nozzle 3"
...
M563 P3 D2:{#move.extruders-1} H3 L-1 S"Nozzle 3" F3; Create Tool 3, use extruder drives 2 (extruder) and the highest numbered extruder drive (assist), Heater 3, no filament mapping, and call it "Nozzle 3"
