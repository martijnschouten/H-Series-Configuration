...
M569 P5 S0 ; Set motor driver direction. Motor driver number 5 goes forwards  (S1). Line 22: paste extruder
...
; Drive settings with paste extruder: might fuck things up
...
M92 X320 Y320 Z640 U322.31 V1600 W800 E400:400:400:400:400:96 ; Set steps per mm
...
M906 X1800 Y2100 Z1800 U1200 V800 W800 E500:500:500:500:500:1000 I30 ; Set motor currents (mA) and motor idle factor in per cent
M84 S5 ; Allow all motors to drop hold current to idle after 5 seconds
...
M950 F3 C"duex.fan3"
M950 F7 C"duex.fan7"; valve for the paste extruder
; M750 ; Enable scanner
