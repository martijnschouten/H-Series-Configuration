...
M308 S2 P"duex.e3temp" Y"pt1000"; Create Sensor 2 assigned to duex.e3temp pin, thermistor type with resistance of 100Kohms at 25C, reciprocal of Steinhart-Hart B coefficient 3950, Steinhart-Hart C coefficient 0, and call it "Nozzle 2"
...
M563 P2 D1:{#move.extruders-1} H2 L-1 S"Nozzle 2" F3; Create Tool 2, use extruder drives 1 (extruder) and the highest numbered extruder drive (assist), Heater 2, no filament mapping, and call it "Nozzle 2"
