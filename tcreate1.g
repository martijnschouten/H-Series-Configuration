...
M308 S1 P"duex.e2temp" Y"pt1000"
M950 H1 C"!exp.heater3" T1; Create Heater 1, assigned to inverse exp.heater3 pin using Sensor 1 for temperature sensing
M143 H1 S295 ; Monitor Heater 1 and throw an error if it exceeds 295C
M563 P1 D0:{#move.extruders-1} H1 L-1 S"Nozzle 1" F3; Create Tool 1, use extruder drives 0 (extruder) and the highest numbered extruder drive (assist), Heater 1, no filament mapping, and call it "Nozzle 1"
